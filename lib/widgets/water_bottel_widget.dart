...
class WaterBottelWidget extends StatefulWidget {
  final List<Map<String, dynamic>> bottleItems;
  final Function(Map<String, dynamic>?) onSelected;

  const WaterBottelWidget({
    super.key,
  ...
  @override
  State<WaterBottelWidget> createState() => _WaterBottelWidgetState();
}

class _WaterBottelWidgetState extends State<WaterBottelWidget> {
